...
--  balance of 10.00.
    UPDATE syntax_practice SET account_balance = 10.00 WHERE
    account_balance = 0 AND transactions_attempted = 0;
...
--8 Add a new record.
    ...
    VALUES
    ('joe', 'minneapolis', 2, 2, 9001);
--9 The bank is losing money in Miami and Phoenix and needs to unload low
--  transaction customers: Delete users that reside in miami OR phoenix
